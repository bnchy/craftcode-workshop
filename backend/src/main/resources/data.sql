...
VALUES
    ...
    ('la chouffe houblon', 9, 'IPA', 1, 1),
    ('grimbergen blanche', 6.2, 'WITBIER', 2, 2),
    ('kasteel tripel', 11, 'TRIPLE', 5, 10),
    ('mechelschen bruynen', 5.8, 'DUBBEL', 4, 1),
    ('vedett extra blonde', 5.2, 'PALE_ALE', 6, 4),
    ('tripel westmalle', 9.5, 'TRAPPIST', 2, 2),
    ('duvel triple hop', 9.5, 'TRIPLE', 6, 1),
    ('delirium red', 8, 'FRUIT', 7, 2),
    ('rodenbach vintage', 7, 'FLEMISH_RED', 8, 8),
    ('brugse zot dubbel', 7.5, 'DUBBEL', 10, 1),
    ('schneider aventinus', 8.2, 'WEISSBIER', 8, 3),
    ('paulaner hefe-weissbier', 5.5, 'WEISSBIER', 8, 3),
    ('samuel adams boston lager', 5, 'LAGER', 6, 4),
    ('chimay red', 7, 'TRAPPIST', 2, 2),
    ('duvel green', 7.5, 'PALE_ALE', 6, 4),
    ('tripel karmeliet blonde', 8.4, 'TRIPLE', 9, 10);