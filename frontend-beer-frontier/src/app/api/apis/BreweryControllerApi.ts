...
export class BreweryControllerApi extends runtime.BaseAPI {
    ...
    /**
     */
    async deleteBreweryByIdRaw(requestParameters: DeleteBreweryByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async deleteBreweryById(requestParameters: DeleteBreweryByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    ...
    /**
     */
    async saveBreweryRaw(requestParameters: SaveBreweryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Brewery>> {
    ...
    /**
     */
    async saveBrewery(requestParameters: SaveBreweryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Brewery> {
        const response = await this.saveBreweryRaw(requestParameters, initOverrides);
        return await response.value();
    }
