...
export class ClassificationControllerApi extends runtime.BaseAPI {
  /**
   */
  async deleteClassificationRaw(
    requestParameters: DeleteClassificationRequest,
  ...
  /**
   */
  async saveClassificationRaw(
    requestParameters: SaveClassificationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Classification>> {
  ...
  async saveClassification(
    ...
    const response = await this.saveClassificationRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
