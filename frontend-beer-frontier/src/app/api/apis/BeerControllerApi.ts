...
import type { Beer, PageBeer } from '../models/index';
import {
  BeerFromJSON,
  BeerToJSON,
  PageBeerFromJSON,
...
export class BeerControllerApi extends runtime.BaseAPI {
   ...
   */
  async getBeersRaw(
    requestParameters: GetBeersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PageBeer>> {
  ...
  /**
   */
  async searchBeersRaw(
    requestParameters: SearchBeersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PageBeer>> {
  ...
  async searchBeers(
    ...
    const response = await this.searchBeersRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
