...
export function BeerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Beer {
    ...
    return {
        ...
        'classifications': json['classifications'] == null ? undefined : (new Set((json['classifications'] as Array<any>).map(ClassificationFromJSON))),
    };
}
...
export function BeerToJSON(value?: Beer | null): any {
    ...
    return {
        ...
        'classifications': value['classifications'] == null ? undefined : (Array.from(value['classifications'] as Set<any>).map(ClassificationToJSON)),
    };
}
